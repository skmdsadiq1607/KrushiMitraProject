...
const Navbar = () => {
  ...
  const publicLinks = [
    ...
    { name: "Outbreak Map", path: "/field-reports", icon: MapPin },
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              <span className="text-lg font-black tracking-tight text-slate-900 dark:text-white flex items-center gap-1">
                Krushi<span className="text-emerald-600 dark:text-emerald-400 font-extrabold">Mitra</span>
              </span>
              <span className="block text-[10px] uppercase font-bold tracking-wider text-slate-500 dark:text-slate-400 -mt-1">
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-3 pl-2 border-l border-slate-200 dark:border-slate-800">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg text-slate-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 dark:text-slate-400 dark:hover:text-red-400 transition-colors"
                  title="Logout"
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  to="/register"
                  className="px-4 py-2 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm shadow-emerald-600/20 hover:shadow-emerald-600/30 hover:-translate-y-0.5 transition-all"
                >
                  Get Started
                </Link>
              </div>
            ...
            {isAuthenticated ? (
              ...
              <div className="grid grid-cols-2 gap-2">
                <Link
                  to="/login"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full text-center py-2 text-xs font-semibold border border-slate-300 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200"
                >
                  Sign In
                </Link>
                <Link
                  to="/register"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full text-center py-2 text-xs font-bold bg-emerald-600 rounded-lg text-white"
                >
                  Get Started
                </Link>
              </div>
