...
import { Sprout, Lock, Mail, User, AlertCircle, ArrowRight, MapPin } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <option value="agronomist">Agronomist / Field Officer</option>
                <option value="student">Agriculture / IT Student</option>
